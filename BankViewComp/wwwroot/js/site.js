$(function () {
    ...
    $("#addProductButton").on('click', function () {
        ...
        if (String($("#productsDiv").html()).trim().length == 0) {
            let aCategory = new Category($("#Branch").val());
            ...
            $.each($(".visually-hidden"), function (index, prodDiv) {
                productList.newProduct(
                    $(prodDiv).find("[name='Customers[" + index + "].CustomerName']").val(),
                    $(prodDiv).find("[name='Customers[" + index + "].DateCreate']").val(),
                    $(prodDiv).find("[name='Customers[" + index + "].Deposit']").val(),
                    $(prodDiv).find("[name='Customers[" + index + "].IsAvailable']").val(),
                    $(prodDiv).find("[name='Customers[" + index + "].ImageUrl']").val(),
                    $(prodDiv).find("[name='Customers[" + index + "].Tid']").val());
            });
            console.log(productList);
            let theCategory = new Category($("#Branch").val());
